...
public class Esame {
	...
	/**
	 * Restituisce il voto solo se esame superato
	 * @return the voto
	 */
	public int getVoto() {
		if (this.superato){
	...
	/**
	 * Se l'esame non è ancora supera lo considera superato con
	 * il voto e la data specificati
	 * se invece è già superato genera una ecezzione.
	 * 
	 * @param voto
	 * @param data
	 */
